...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Edit Current Branch</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Current Branch</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card">
                <form id="branch_form" name="branch_form" action="{{ route('user.branch.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="d-flex align-items-center avatar_wrapper" id="avatar_wrapper">
                                    ...
                                    @else
                                    <img src="{{ asset('storage/' . $branch->picture) }}" id = "branch_avatar" class="branch_avatar" width="100"/>
                                    @endif
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" id="name" name="name" value="{{ $branch->name}}">
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Country" id="country" name="country" value="{{$branch->country}}">
                                    </div>
                                </div>
                                @error('country')
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="City" id="city" name="city" value="{{$branch->city}}">
                                    </div>
                                </div>
                                @error('city')
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="manager_id" name="manager_id">
                                        ...
                                        @foreach($managers as $manager)
                                            ...
                                            <option value="{{ $manager->id }}" selected>{{ $manager->firstName }}</option>
                                            @else
