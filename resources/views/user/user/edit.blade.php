...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card">
                <form id="user_form" name="user_form" action="{{ route('user.user.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="d-flex align-items-center avatar_wrapper" id="avatar_wrapper">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/' . $user->photo) }}" id="user_avatar" class="rounded-circle user_avatar" width="100" />
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="role" name="role">
                                        ...
                                        <option value="3" selected>Branch Manager</option>
                                        @endif
                                    </select>
                                </div>
                                @error('role')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="inactive_status" name="active" value="0" {{ $user->active == 0? 'checked': '' }} >
                                            <label class="custom-control-label" for="inactive_status">In Active</label>
                                        </div>
                                    </div>
                                    <div class="form-check">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="active_status" name="active" value="1" {{ $user->active == 1? 'checked': '' }}>
