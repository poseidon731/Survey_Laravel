...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card">
                <form id="user_form" name="user_form" action="{{ route('user.device.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Device Name" id="name" name="name" value="{{ $device->name }}">
                                    </div>
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Last Name" id="mac_num" name="mac_num" value="{{ $device->mac_num }}">
                                    </div>
                                </div>
                                @error('mac_num')
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
