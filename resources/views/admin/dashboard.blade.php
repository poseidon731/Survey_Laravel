...
<div class="container-fluid">
                ...
                <div class="card-body border-top">
                    <div class="row m-b-0">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex align-items-center">
                                <div class="m-r-10"><span class="text-pink display-5"><i
                  ...
                  class="mdi mdi-currency-usd"></i></span></div>
    ...
    <div class="row">
                    ...
                    <div class="row m-t-40">
                        ...
                        <div class="col-lg-6">
                            ...
                            <ul class="list-style-none">
                                ...
                                <li class="m-t-20"><i class="fas fa-circle m-r-5 text-pink font-12"></i> Un-Open Ratio <span class="float-right">25%</span></li>
        ...
        <div class="col-lg-4 col-xl-6">
            <div class="card card-hover p-t-10">
                <div class="card-body">
                    <div class="p-t-20 text-center">
                        <i class="mdi mdi-file-chart display-4 text-pink d-block"></i>
