...
<head>
    ...
    <link href="<?php echo e(asset('libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('libs/morris.js/morris.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('extra-libs/c3/c3.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('libs/toastr/build/toastr.min.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/user">
                        ...
                        <!-- <?php echo e(print_r($logo_url)); ?> -->
                        <span class="logo-text">
							<img src="<?php echo e(asset('images/logo-text.png')); ?>" alt="homepage" class="dark-logo" />
							<img src="<?php echo e(asset('storage/'.$logo_url)); ?>" class="light-logo image_filter" alt="homepage" />
						</span>
                    </a>
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> 
                                                    <img src="<?php echo e(asset('images/users/1.jpg')); ?>" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> 
                                                    <img src="<?php echo e(asset('images/users/2.jpg')); ?>" alt="user" class="rounded-circle"> 
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> 
                                                    <img src="<?php echo e(asset('images/users/3.jpg')); ?>" alt="user" class="rounded-circle"> 
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="<?php echo e(asset('images/users/4.jpg')); ?>" alt="user" class="rounded-circle"> 
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if(Auth::user()->photo != ''): ?>
                                    <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" alt="user" class="rounded-circle" width="31"> 
                                <?php else: ?>
                                    <img src="<?php echo e(asset('images/users/1.jpg')); ?>" alt="user" class="rounded-circle" width="31">
                                <?php endif; ?>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <?php if(Auth::user()->photo != ''): ?>
                                            <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" alt="user" class="rounded-circle" width="61"> 
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('images/users/1.jpg')); ?>" alt="user" class="rounded-circle"> 
                                        <?php endif; ?>
                                    </div>
                                    <div class="m-l-10">
                                        <h4 class="m-b-0"><?php echo e(Auth::user()->firstName); ?> <?php echo e(Auth::user()->lastName); ?></h4>
                                        <p class=" m-b-0"><?php echo e(Auth::user()->email); ?></p>
                                    </div>
                                </div>
                                <a class="dropdown-item" href="<?php echo e(route('user.user.profile')); ?>"><i class="ti-user m-r-5 m-l-5"></i>
									My Profile
                                </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="<?php echo e(route('user.dashboard')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-emoticon-cool"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.user.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Users </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.user.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-control-shuffle"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.branch.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Branchs </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.branch.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class=" fab fa-servicestack"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.survey.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Surveys </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.survey.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="far fa-frown"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.rating.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Ratings </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.rating.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="<?php echo e(route('user.brand.index')); ?>" aria-expanded="false">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-mobile-alt"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.device.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Devices </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.device.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-stackexchange"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.template.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> All Templates </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.template.create')); ?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-info-circle"></i><span
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.companyinfo.list')); ?>" class="sidebar-link">
                                        <i class="mdi mdi-minus"></i><span class="hide-menu"> Social Links </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('user.companyinfo.logo')); ?>" class="sidebar-link">
    ...
    <script src="<?php echo e(asset('js/app.init.dark.js')); ?>"></script>
    ...
    <script>
        var base_url_s = "<?php echo e(url('/')); ?>";
    </script>
    <script src="<?php echo e(asset('js/pages/user/realtime.js')); ?>"></script>
    <?php echo $__env->yieldContent('scripts'); ?>
</body>

</html><?php /**PATH E:\Projects\Laravel\Survey systems\survey_laravel\resources\views/layouts/user.blade.php ENDPATH**/ ?>